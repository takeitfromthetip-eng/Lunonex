...
router.post('/create', async (req, res) => {
  try {
    const result = await aiProxy.generate('deepfake-detector', JSON.stringify(req.body));
...
router.get('/list', async (req, res) => {
  try {
    const result = await aiProxy.generate('deepfake-detector-list', JSON.stringify(req.query));
