...
router.post('/create', async (req, res) => {
  try {
    const result = await aiProxy.generate('copyright-protection', JSON.stringify(req.body));
...
router.get('/list', async (req, res) => {
  try {
    const result = await aiProxy.generate('copyright-protection-list', JSON.stringify(req.query));
