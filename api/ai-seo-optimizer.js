...
router.post('/create', async (req, res) => {
  try {
    const result = await aiProxy.generate('seo-optimizer', JSON.stringify(req.body));
...
router.get('/list', async (req, res) => {
  try {
    const result = await aiProxy.generate('seo-optimizer-list', JSON.stringify(req.query));
